...
const specialActivityRoutes = require(path.join(__dirname, 'routes', 'specialActivities'));
...
app.use('/api/specialActivity', specialActivityRoutes); // Keep consistent with your other API routes
