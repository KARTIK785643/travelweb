...
const Login = () => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      // Check if res.data.details exists and contains the type
      const userType = res.data.details?.type || res.data.type;
      ...
      setLoading2(false);
      Swal.fire(err.response?.data || "An error occurred", "", "error");
    }
  };
